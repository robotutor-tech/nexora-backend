...
@SpringBootTest
@ContextConfiguration(classes = [ApplicationAuthorizeAspectIntegrationTest.TestConfig::class])
class ApplicationAuthorizeAspectIntegrationTest {
    ...
    class TestConfig {
        ...
        @Bean
        fun accessAuthorizer(): AccessAuthorizer = object : AccessAuthorizer {
