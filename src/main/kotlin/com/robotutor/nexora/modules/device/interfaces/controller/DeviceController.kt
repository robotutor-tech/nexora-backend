...
class DeviceController(
    ...
    @GetMapping("/{deviceId}")
    fun getDevice(@PathVariable deviceId: String, actorData: ActorData): Mono<DeviceResponse> {
        return deviceUseCase.getDevice(DeviceId(deviceId), actorData.premisesId)
            .map { DeviceMapper.toDeviceResponse(it) }
    }
}