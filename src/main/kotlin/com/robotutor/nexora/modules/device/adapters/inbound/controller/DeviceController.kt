package com.robotutor.nexora.modules.device.adapters.inbound.controller
...
import com.robotutor.nexora.modules.device.adapters.inbound.controller.mapper.DeviceMapper
...
class DeviceController(
    ...
    fun registerDevice(
        ...
        val deviceDetails = DeviceMapper.toDeviceDetails(deviceRequest, invitationData)
        return deviceUseCase.register(deviceDetails)
