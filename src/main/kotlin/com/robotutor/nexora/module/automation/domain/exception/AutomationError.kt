package com.robotutor.nexora.module.automation.domain.exception

import com.robotutor.nexora.shared.domain.exception.ServiceError


enum class AutomationError(override val errorCode: String, override val message: String) : ServiceError {
