...
import com.robotutor.nexora.module.identity.domain.event.CredentialUpdatedEvent
...
class AccountAggregate private constructor(
    ...
    companion object {
        fun register(
            ...
            val account = create(accountId, type, subjectId, createdBy, credentials)
            account.addEvent(AccountCreatedEvent(account.accountId, account.type, account.subjectId))
            return account
        }
