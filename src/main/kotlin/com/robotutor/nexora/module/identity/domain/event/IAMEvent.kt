...
data class AccountCreatedEvent(val accountId: AccountId, val type: SubjectType, val subjectId: SubjectId) :
    IdentityEvent

data class AccountRegistrationFailedEvent(val type: SubjectType, val subjectId: SubjectId) : IdentityEvent
