package com.robotutor.nexora.shared.adapters.persistance.service

import com.robotutor.nexora.shared.adapters.persistance.model.ID_SEQUENCE_COLLECTION
import com.robotutor.nexora.shared.adapters.persistance.model.IdSequence
...
@Repository
class MongoIdGeneratorService(private val reactiveMongoTemplate: ReactiveMongoTemplate) : IdGeneratorService {
