...
import com.robotutor.nexora.context.device.infrastructure.persistence.mapper.DeviceMongoSpecificationTranslator
...
class MongoDeviceRepository(
    ...
    override fun findAll(specification: Specification<DeviceAggregate>): Flux<DeviceAggregate> {
        val query = Query(DeviceMongoSpecificationTranslator.translate(specification))
