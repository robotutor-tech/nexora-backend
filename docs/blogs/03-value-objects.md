# Chapter 3: Value Objects - Building Bulletproof Domain Models
...
1. [The Problem: Primitive Obsession](#the-problem)
2. [What Are Value Objects?](#what-are-value-objects)
3. [Characteristics of Value Objects](#characteristics)
4. [Real-World Examples from SmartHome Hub](#real-examples)
5. [Implementation Strategies](#implementation)
6. [Advanced Value Object Patterns](#advanced-patterns)
7. [Testing Value Objects](#testing)
8. [Common Pitfalls](#pitfalls)

---

## <a name="the-problem"></a>1. The Problem: Primitive Obsession
...
## <a name="what-are-value-objects"></a>2. What Are Value Objects?
...
## <a name="characteristics"></a>3. Characteristics of Value Objects
...
## <a name="implementation"></a>5. Implementation Strategies
...
## <a name="advanced-patterns"></a>6. Advanced Value Object Patterns
...
## <a name="testing"></a>7. Testing Value Objects
...
1. **Value objects eliminate primitive obsession** - Type safety prevents bugs

2. **Self-validation** - Impossible to create invalid value objects

3. **Immutability** - Thread-safe and predictable

4. **Structural equality** - Two value objects with same values are equal

5. **Encapsulate business rules** - Domain knowledge in one place

6. **Use `@JvmInline`** - No performance penalty for simple value objects

7. **Test thoroughly** - Value objects are easy to test in isolation

---

## 🎯 Practical Exercise

Transform these primitives into value objects in your codebase:

1. **String email** → `Email` value object
2. **String password** → `Password` value object
3. **String phone** → `Mobile` value object
...
Ready to learn about entities and aggregates?

👉 **[Chapter 4: Entities and Aggregates - Protecting Your Business Invariants](./04-entities-and-aggregates.md)**
