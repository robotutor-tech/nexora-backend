# Chapter 2: Anemic vs Rich Domain Models - The Most Common DDD Mistake
...
1. [The Problem: The Anemic Domain Model Anti-Pattern](#the-problem)
2. [What is an Anemic Domain Model?](#what-is-anemic)
3. [Real-World Disaster: Device Management in SmartHome Hub](#real-example)
4. [The Cost of Anemic Models](#the-cost)
5. [Step-by-Step Refactoring Guide](#refactoring-guide)
6. [Rich Domain Model Benefits](#benefits)
7. [Common Pitfalls and How to Avoid Them](#pitfalls)
8. [Testing Rich vs Anemic Models](#testing)
9. [Migration Strategy](#migration)

---

## <a name="the-problem"></a>1. The Problem: The Anemic Domain Model Anti-Pattern
...
## <a name="what-is-anemic"></a>2. What is an Anemic Domain Model?
...
## <a name="real-example"></a>3. Real-World Disaster: Device Management in SmartHome Hub
...
## <a name="the-cost"></a>4. The Cost of Anemic Models
...
## <a name="refactoring-guide"></a>5. Step-by-Step Refactoring Guide
...
## <a name="benefits"></a>6. Rich Domain Model Benefits
...
## <a name="pitfalls"></a>7. Common Pitfalls and How to Avoid Them
...
## <a name="testing"></a>8. Testing Rich vs Anemic Models
...
## <a name="migration"></a>9. Migration Strategy
...
1. **Anemic models are data bags with no behavior** - Violates OOP principles

2. **Rich models encapsulate business logic** - Methods express intent clearly

3. **Immutability prevents bugs** - Use `val` and return new instances

4. **Domain methods are self-documenting** - `device.activate()` vs `device.copy(status = "ACTIVE")`

5. **Test domain logic in isolation** - No infrastructure mocks needed

6. **Domain events belong in domain** - Published automatically on state changes

7. **Single source of truth** - Business rules in one place

8. **Migrate incrementally** - Don't rewrite everything at once

9. **Measure the impact** - Track bugs, development time, code quality
...
### Exercise 1: Identify Anemic Model
1. Find a data class in your codebase
2. Where is the business logic for this class?
3. Is it scattered across services?

### Exercise 2: Add One Behavior Method
1. Pick the most common operation
2. Move logic from service to entity
3. Make it a method (e.g., `activate()`)

### Exercise 3: Write Domain Test
1. Test the method without mocks
2. Test business rules (edge cases)
3. Compare with service test

### Exercise 4: Measure Impact
1. Count lines of code before/after
2. Count test mocks before/after
3. Time to add a new feature
...
### Books
- **"Domain-Driven Design"** - Eric Evans (Original, 2003)
- **"Implementing Domain-Driven Design"** - Vaughn Vernon (2013)

### Articles
- Martin Fowler's Anemic Domain Model: https://martinfowler.com/bliki/AnemicDomainModel.html

### Code Examples
- SmartHome Hub Backend: Complete working examples

---

## 🚀 Next Chapter

Ready to build bulletproof value objects?

👉 **[Chapter 3: Value Objects - Building Bulletproof Domain Models](./03-value-objects.md)**
...
**What's your biggest challenge with anemic models?**
...
**Ready to continue?** → [Chapter 3: Value Objects](./03-value-objects.md)
